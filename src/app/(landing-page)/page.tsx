...
export default function Home() {
  return (
    <CommonBody hasName showHeader hasNavigations>

      <section id="top" className="relative mx-auto grid max-w-[98%] gap-16 px-6 pb-24 pt-16 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.08fr)] lg:px-8 lg:pb-28 lg:pt-16">
        <div className="relative z-10 flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <Button href={"/register"} className="h-12 rounded-md bg-linear-to-b from-yellow-300 to-yellow-500 px-6 text-sm font-semibold text-black shadow-[0_12px_30px_rgba(250,204,21,0.18)] hover:from-yellow-200 hover:to-yellow-400">
